<script lang="ts">
	...
	// Store checked state: key = "Day_SessionId" (e.g. "Senin_1")
	let checkedSchedules = new Set<string>();
				...
				<Card.Content>
					{#if data.isRegistered}
						<div class="bg-green-100 p-4 rounded text-green-800">
							...
							<p>Anda sudah mendaftar di praktikum ini. Slahkan menunggu untuk pengumuman jadwal</p>
						</div>
					{:else}
						{#if form?.message}
							<div
